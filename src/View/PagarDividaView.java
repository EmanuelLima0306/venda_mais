 ...
 * @author celso
 */
public class PagarDividaView extends javax.swing.JFrame {

    /**
     * Creates new form PagarDividaView
     */
    public PagarDividaView() {
        initComponents();
        carregarCliente();
    ...
    private void carregarFactura() {
        ...
        cboFactura.setModel(new DefaultComboBoxModel(fController.getFacturaDividaCliente(modelo.getId()).toArray()));
    }
    ...
    private void initComponents() {
        ...
        setTitle("Pagamento de Divida do Cliente");
        ...
        btnImprimirDivida.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGUENS/faturação2.png"))); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cboFactura, 0, 331, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cboCliente, 0, 349, Short.MAX_VALUE)
    ...
    private void cboClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboClienteActionPerformed
        ...
        FacturaController fController = new FacturaController();
        ClienteModel modelo = (ClienteModel) cboCliente.getSelectedItem();
        txtTotalDivida.setText(String.valueOf(fController.getTotalDividaCliente(modelo.getId())));
    ...
    private void cboFacturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboFacturaActionPerformed
        ...
        txtValorDivida.setText(String.valueOf(fController.getTotalFactura(fmodel.getId())));
    ...
    private void cboFormaPagamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboFormaPagamentoActionPerformed
        ...
        txtMulticaixa.setText(modelo.isMulticaixa() ? txtValorDivida.getText() : "0");
        ...
        try {
            ...
            if (fpmodelo.isCash() || fpmodelo.isMulticaixa()) {
                if (troco >= 0) {
                    ...
                    modelo.setTroco(troco);
                    modelo.setValorEntregue(cash);
                    modelo.setFormaPagamento(fpmodelo);
                    modelo.setValorMulticaixa(multicaixa);

                    if (fController.update(modelo)) {
                        carregarFactura();
            ...
            JOptionPane.showMessageDialog(this, "Nao existe factura");
        }
    ...
    private void btnFacturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFacturaActionPerformed
        ...
        //
        try {
            String numFactura = cboFactura.getSelectedItem().toString();
            if (!numFactura.isEmpty()) {

                int id = Integer.parseInt(numFactura);
                FacturaModel facturaModel = new FacturaModel(id);
                FacturaIreport.A4(facturaModel,"Factura Recibo",false);
            }
        } catch (Exception ex) {
    ...
    private void btnImprimirDividaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirDividaActionPerformed
        ...
        if (!modelo.isEmpty()) {
            ...
            FacturaIreport.DividaCliente(modelo.getId());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PagarDividaView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PagarDividaView().setVisible(true);
            }
        });
    }
