 ...
 */
public class BalcaoRestauranteView extends javax.swing.JPanel {
    ...
    public BalcaoRestauranteView() {
        initComponents();
        this.setName("BalcaoView");

    }

    public BalcaoRestauranteView(UsuarioModel usuario, MesaModel mesa, JFrame pedidoMesaView) {
        initComponents();
        this.setName("BalcaoView");
        this.getName();
    ...
    public BalcaoRestauranteView(UsuarioModel usuario, boolean permitirFecho, JFrame pedidoMesaView) {
        initComponents();
        this.setName("BalcaoView");
    ...
    public BalcaoRestauranteView(UsuarioModel usuario, MesaModel mesa, boolean permitirFecho, JFrame pedidoMesaView) {
        initComponents();
        this.setName("BalcaoView");
        this.usuario = usuario;
        this.pedidoMesaView = pedidoMesaView;
...
//        cboProduto.setSelectedIndex(-1);
    ...
    private void initComponents() {
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addComponent(jLabel23, javax.swing.GroupLayout.PREFERRED_SIZE, 864, Short.MAX_VALUE)
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addComponent(tabulacao, javax.swing.GroupLayout.DEFAULT_SIZE, 884, Short.MAX_VALUE)
        ...
        jPanel7Layout.setVerticalGroup(
            jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addComponent(tabulacao, javax.swing.GroupLayout.PREFERRED_SIZE, 434, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                    ...
                    if (!facturaModel.isEmpty()) {
                        ...
                        if (controller.saveOrUpdate(facturaModel)) {
                            ...
                            try {
                                ...
                                Logger.getLogger(BalcaoRestauranteView.class.getName()).log(Level.SEVERE, null, ex);
...
//                            iva = this.totalAnterior <= 0 ? 0 : 14;
                            ...
                            modelo.setDesconto(Calculo.getValueNormal(tbPedido.getValueAt(index, 6).toString()));
                            modelo.setRetencao(Calculo.getValueNormal(tbPedido.getValueAt(index, 7).toString()));
                            modelo.setTotal(Calculo.getValueNormal(tbPedido.getValueAt(index, 8).toString()));
