...
public class StockIreport {
    ...
    public static void presteExpirar() {

        String relatorio = "Relatorio/ListaStockPresteExpirar.jasper";
        Connection connection = conFactory.open();
    ...
    public static void presteTerminar() {
    ...
    public static void listarEntrada(int idEntrada) {

        String relatorio = "Relatorio/ListaEntradaProduto.jasper";
        Connection connection = conFactory.open();

        File file = new File(relatorio).getAbsoluteFile();
        String obterCaminho = file.getAbsolutePath();
        HashedMap hashMap = new HashedMap();
        hashMap.put("ID_ENTRADA", idEntrada);
        try {
            JasperFillManager.fillReport(obterCaminho, hashMap, connection);
