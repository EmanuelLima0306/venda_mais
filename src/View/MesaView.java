...
public class MesaView extends javax.swing.JFrame {
    ...
    private void carregado() {
        ...
        cboMesa.setModel(new DefaultComboBoxModel(controller.get().toArray()));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Mesa Existente");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(cboMesa, 0, 354, Short.MAX_VALUE))))
    ...
    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarActionPerformed
        ...
        MesaController controller = new MesaController();
        controller.ireportMesa();
        LogUtil.log.salvarLog(TipoLog.INFO, " Mesa ( "+evt.getActionCommand()+" )");
    }//GEN-LAST:event_btnListarActionPerformed

    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed

        MesaModel modelo = new MesaModel(id, txtDesignacao.getText(),
                new EstadoModel(1, ""));

        if (!modelo.isEmpty()) {

            MesaController controller = new MesaController();
            MesaModel modeloAux = controller.getAll(txtDesignacao.getText());
            //-----------Verificar se a categoria existe se existe e esta eliminada activa
            if (id == 0 &&  modeloAux.getId() > 0 && modeloAux.getEstado().getId() == 1) {
                JOptionPane.showMessageDialog(this, "Esta Mesa ja existe no sistema", "Alerta", JOptionPane.WARNING_MESSAGE);
                return;
            ...
            if (controller.saveOrUpdate(modelo)) {
                ...
                LogUtil.log.salvarLog(TipoLog.INFO, " Salvou Mesa ( "+modelo.getDesignacao()+" )");
                limpar();
                carregado();
    ...
    private void cboMesaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboMesaActionPerformed
        // TODO add your handling code here:
        MesaModel modelo = (MesaModel) cboMesa.getSelectedItem();
        id = modelo.getId();
        ...
        if (id > 0) {
            ...
            if (op == JOptionPane.YES_OPTION) {
                ...
                if (controller.update(modelo)) {
                    ...
                    JOptionPane.showMessageDialog(this, "Mesa eliminada com sucesso");
                    LogUtil.log.salvarLog(TipoLog.INFO, " Eliminou Mesa ( "+modelo.getDesignacao()+" )");
                    limpar();
                    carregado();
