...
public class ClienteIreport {
    ...
    public static void Devedor() {

        String relatorio = "Relatorio/ListaClienteDevedor.jasper";
        Connection connection = conFactory.open();
