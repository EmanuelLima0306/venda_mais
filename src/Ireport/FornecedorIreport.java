...
public static void entradaPorFornecedor() {

        String relatorio = "Relatorio/ListaExistenciaFornecedor.jasper";
        Connection connection = conFactory.open();
...
public static void entradaPorFornecedor(int idFornecedor) {

        String relatorio = "Relatorio/ListaExistenciaPorFornecedor.jasper";
        Connection connection = conFactory.open();

        File file = new File(relatorio).getAbsoluteFile();
        String obterCaminho = file.getAbsolutePath();
        HashedMap hashMap = new HashedMap();
        hashMap.put("COD_FORNECEDOR", idFornecedor);
        try {
            JasperFillManager.fillReport(obterCaminho, hashMap, connection);
