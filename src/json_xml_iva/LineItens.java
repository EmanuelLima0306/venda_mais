...
public class LineItens {
    ...
    public class LineItem {
        ...
        List<LineItensReferences.References> References = new ArrayList<>();
        ...
        public List<LineItensReferences.References> getReferences() {
            return References;
        }

        public void setReferences(List<LineItensReferences.References> References) {
